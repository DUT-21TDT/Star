...
const PostModerator: React.FC<IProps> = (props) => {
  ...
  const getViolenceScoreIcon = (score: number | undefined) => {
    if (score === undefined || score === null)
      return <HiEmojiHappy className="size-4 inline-block mb-1" />;
  ...
  return (
    <>
          ...
          <div className="flex justify-between w-full">
            ...
            {violenceScore !== undefined && (
              <div className="flex items-center gap-2">
                ...
                <p
                  className="text-sm rounded-xl px-2 py-[2px] border-2 cursor-pointer hover:bg-gray-100 "
                  style={{ color: getReportColor(numberOfReports) }}
                  onClick={() => setOpenModalReported(true)}
                >
                  {numberOfReports}
      ...
      <ModalViewReportedPost
        isOpenModal={openModalReported}
        setIsOpenModal={setOpenModalReported}
        dataDetailPost={{
          id,
          usernameOfCreator,
          avatarUrlOfCreator,
