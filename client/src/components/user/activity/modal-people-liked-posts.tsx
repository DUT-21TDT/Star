...
import { useGetAllActivitiesLikeOnDetailPost } from "../../../hooks/notification";
  ...
  useEffect(() => {
    return () => {
      queryClient.resetQueries({
        queryKey: [QUERY_KEY.fetchAllActivitiesLikeOnPostDetail(id)],
      });
    };
  }, []);
...
export default ModalViewPeopleLikePost;
