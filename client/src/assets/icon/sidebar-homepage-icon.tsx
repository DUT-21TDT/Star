  ...
  const items: MenuProps["items"] = [
    {
      key: "title",
      label: (
        <div className="w-[150px] h-[35px] text-[18px] font-semibold flex items-center justify-start">
          Change password
        </div>
      ),
    ...
    },
    {
      key: "1",
      label: (
        <div className="w-[100px] h-[35px] text-[18px] font-semibold flex items-center justify-start">
          Log out
        </div>
      ),
