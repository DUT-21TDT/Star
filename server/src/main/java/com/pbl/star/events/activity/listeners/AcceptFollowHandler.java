...
public class AcceptFollowHandler implements UserActivityHandler {
    ...
    public AcceptFollowHandler(NotificationService notificationService, SSEManager sseManager, NotificationDTOMapper mapper) {
    ...
    public void handle(Message message) throws IOException {
        ...
        Notification noti = notificationService.createFollowUserNotification(followingId, followerId, followeeId, timestamp, NotificationType.ACCEPT_FOLLOW);
