...
public class RejectPostHandler implements UserActivityHandler {
    ...
    public RejectPostHandler(NotificationService notificationService) {
    ...
    public void handle(Message message) throws IOException {
        ...
        notificationService.createModeratePostNotification(postId, timestamp, NotificationType.REJECT_POST);
    }
